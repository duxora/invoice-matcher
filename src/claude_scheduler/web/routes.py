...
_loader = ChoiceLoader([
    FileSystemLoader(str(_TEMPLATES_DIR / "scheduler")),
...
async def dashboard(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/dashboard.html", app_context(
...
async def history(
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/history.html", app_context(
...
async def errors(
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/errors.html", app_context(
...
async def tickets(
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/tickets.html", app_context(
...
async def notifications(
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/notifications.html", app_context(
...
async def doctor(request: Request):
    ...
    return templates.TemplateResponse("scheduler/doctor.html", app_context(
...
async def tasks_new_form(request: Request):
    return templates.TemplateResponse("scheduler/task_new.html", app_context(request))
...
async def view_log(request: Request, slug: str):
    ...
    return templates.TemplateResponse("scheduler/log_view.html", app_context(
...
async def approvals(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse("scheduler/approvals.html", app_context(
